...
public class RETC_51_PropertyDetailsInTrash {
	...
	public void validLoginTest() {
		...
		WebElement restoredProperty = driver.findElement(By.cssSelector("a.row-title"));
		boolean displayed3 = restoredProperty.isDisplayed();
		softAssert.assertEquals(displayed3, true);
